...
import { ROLE_SUPER_ADMIN, ROLE_ESTABLISHMENT, ROLE_HOD, ROLE_PRINCIPAL, ROLE_DEAN, ROLE_TEACHING, ROLE_NON_TEACHING, isRoleMatch } from '../../utils/role';
...
export default function Sidebar() {
  ...
  if (isRoleMatch(user?.role, ROLE_DEAN)) return <PrincipalDeansidebar />;
