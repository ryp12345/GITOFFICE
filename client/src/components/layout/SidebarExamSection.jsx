...
export default function SidebarExamSection() {
  ...
  const links = [
    { name: 'My Dashboard', path: '/exam-section', icon: '📊' },
    {
      name: 'FASTRACK',
      icon: '⚡',
      submenu: [
        { name: 'Configure Scheme', path: '/exam-section/fastrack-scheme-config' },
        { name: 'Configure Course Types', path: '/exam-section/fastcourse-setup' },
        { name: 'Fastrack Instance', path: '/exam-section/fastrack-instance' },
        { name: 'Configure Courses', path: '/exam-section/fastrack' },
        { name: 'Expenses Master', path: '/exam-section/fastrack-expenses-master' },
      ]
    },
    {
      ...
      icon: '💰',
      submenu: [
        { name: 'Pay Configuration', path: '/exam-section/fastrackpay' },
        { name: 'Fastrack Expenses', path: '/exam-section/fastrack-expenses' },
        { name: 'Fastrack Insights', path: '/exam-section/fastrack-insights' },
      ]
    },
    { name: 'Program', path: '/exam-section/coeprogram', icon: '🎓' },
  ];
