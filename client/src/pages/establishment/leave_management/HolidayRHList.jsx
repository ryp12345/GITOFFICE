              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-blue-600">
                    <tr>
                      ...
                      <th className={`px-6 py-4 text-left text-xs font-medium text-white uppercase tracking-wider ${
                        String(user?.role || '').toLowerCase() === 'establishment' ? '' : 'rounded-tr-xl'
                      }`}>
                        Type
                      </th>
                      {String(user?.role || '').toLowerCase() === 'establishment' && (
                        <th className="px-6 py-4 text-center text-xs font-medium text-white uppercase tracking-wider rounded-tr-xl">Actions</th>
                      )}
                    </tr>
                  </thead>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {loading ? (
                      <tr>
                        <td colSpan={String(user?.role || '').toLowerCase() === 'establishment' ? 7 : 6} className="px-6 py-12 text-center text-gray-500">Loading...</td>
                      </tr>
                    ) : filtered.length === 0 ? (
                      <tr>
                        <td colSpan={String(user?.role || '').toLowerCase() === 'establishment' ? 7 : 6} className="px-6 py-12 text-center text-gray-500">No records found</td>
                      </tr>
                    ) : (
