...
export default function DepartmentsPage() {
  ...
  const submit = async (e) => {
    ...
    try {
      const payload = {
        ...
        dept_shortname: form.dept_shortname,
        yoe: form.yoe,
        status: form.status,
      };
      if (editingId) {
  ...
  const remove = async (id) => {
    if (!window.confirm('Delete this department? This action is permanent.')) return;
    try {
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-100">
                    <tr>
                      ...
                      <th className="px-3 py-2 border-b text-left text-sm font-semibold text-gray-700">Department Name</th>
                      <th className="px-3 py-2 border-b text-left text-sm font-semibold text-gray-700">Short Name</th>
                      <th className="px-3 py-2 border-b text-left text-sm font-semibold text-gray-700">Year of Establishment</th>
                      <th className="px-3 py-2 border-b text-left text-sm font-semibold text-gray-700">Status</th>
                      <th className="px-3 py-2 border-b text-center text-sm font-semibold text-gray-700">Actions</th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-gray-200">
                    {loading ? (
                      ...
                      <tr><td colSpan="8" className="px-6 py-12 text-center text-gray-500">No departments found</td></tr>
                    ) : (
                      ...
                      <form className="space-y-5" onSubmit={submit}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                          ...
                          <div className="md:col-span-1">
                            ...
                            <input
                              type="text"
                              value={form.dept_shortname}
                              onChange={e=>setForm({ ...form, dept_shortname: e.target.value })}
                              className="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          ...
                          <div className="md:col-span-1">
                            <label className="block mb-2 text-sm font-medium text-gray-700">Year of Establishment *</label>
                            <input
                              type="date"
                              value={form.yoe}
